r"""
Seed test accounts and mock conversations for testing.
Usage: .venv\Scripts\python.exe scripts\seed_test_conversations.py
"""
import json
...
def api(method: str, path: str, body: dict | None = None) -> dict:
    """Call REST API, return parsed JSON."""
    data = None
    if body is not None:
...
def main():
    ...
    # ── Register Agents (required for handover) ──
    agents_map = {
    ...
    # ── Register AppUsers (required for block/unblock, customer profile) ──
    users = [
