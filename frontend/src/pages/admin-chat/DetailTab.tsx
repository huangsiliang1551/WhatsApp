...
export function DetailTab({ conversation, aiStatus }: DetailTabProps): JSX.Element {
  ...
  const customerPublicUserId =
    (conversation as ConversationSummary & { customer_public_user_id?: string | null }).customer_public_user_id ??
      ...
      <Descriptions column={1} size="small" bordered>
        ...
        <Descriptions.Item label="客户">
          <MemberIdLink
            ...
            publicUserId={customerPublicUserId}
            label={customerPublicUserId}
          />
        </Descriptions.Item>
