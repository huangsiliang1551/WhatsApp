...
EXTENSION_PERMISSION_DEFINITIONS: list[dict[str, Any]] = [
    ...
    {"code": "tasks.config.view", "module": "tasks", "label": "View Task Config", "description": "View task system configuration.", "super_admin_only": False},
    {"code": "tasks.config.manage", "module": "tasks", "label": "Manage Task Config", "description": "Create or update task system configuration.", "super_admin_only": False},
    {"code": "tasks.quota.view", "module": "tasks", "label": "View Task Quotas", "description": "View member task day quotas.", "super_admin_only": False},
    {"code": "tasks.quota.create", "module": "tasks", "label": "Create Task Quotas", "description": "Create member task day quotas.", "super_admin_only": False},
    {"code": "tasks.quota.update", "module": "tasks", "label": "Update Task Quotas", "description": "Update member task day quotas.", "super_admin_only": False},
    {"code": "tasks.quota.batch_create", "module": "tasks", "label": "Batch Create Task Quotas", "description": "Batch create member task day quotas.", "super_admin_only": False},
    {"code": "tasks.quota.cancel", "module": "tasks", "label": "Cancel Task Quotas", "description": "Cancel member task day quotas.", "super_admin_only": False},
    {"code": "tasks.product_pool.view", "module": "tasks", "label": "View Task Product Pools", "description": "View task product pools and items.", "super_admin_only": False},
    {"code": "tasks.product_pool.manage", "module": "tasks", "label": "Manage Task Product Pools", "description": "Create or modify task product pools and items.", "super_admin_only": False},
    {"code": "tasks.issue_plan.view", "module": "tasks", "label": "View Task Issue Plans", "description": "View task issue plans and derived day rules.", "super_admin_only": False},
    {"code": "tasks.issue_plan.manage", "module": "tasks", "label": "Manage Task Issue Plans", "description": "Create or update task issue plans.", "super_admin_only": False},
    {"code": "tasks.issue_plan.enable", "module": "tasks", "label": "Enable Task Issue Plans", "description": "Enable or disable task issue plans.", "super_admin_only": False},
    {"code": "tasks.instance.view", "module": "tasks", "label": "View Task Instances", "description": "View task package instance details.", "super_admin_only": False},
    {"code": "tasks.instance.pause", "module": "tasks", "label": "Pause Task Instances", "description": "Pause task package instances.", "super_admin_only": False},
    {"code": "tasks.instance.resume", "module": "tasks", "label": "Resume Task Instances", "description": "Resume paused task package instances.", "super_admin_only": False},
    {"code": "tasks.instance.cancel", "module": "tasks", "label": "Cancel Task Instances", "description": "Cancel task package instances.", "super_admin_only": False},
    {"code": "tasks.manual_add.view", "module": "tasks", "label": "View Task Manual Add", "description": "View task manual-add candidates, logs, and previews.", "super_admin_only": False},
    {"code": "tasks.manual_add.create", "module": "tasks", "label": "Create Task Manual Add", "description": "Append manual-add products to task packages.", "super_admin_only": False},
    {"code": "tasks.manual_add.approve", "module": "tasks", "label": "Approve Task Manual Add", "description": "Approve manual-add operations when required.", "super_admin_only": False},
    {"code": "tasks.monitor.view", "module": "tasks", "label": "View Task Monitor", "description": "View task monitor queries, summaries, alerts, and streams.", "super_admin_only": False},
    {"code": "tasks.monitor.manage_saved_view", "module": "tasks", "label": "Manage Task Monitor Saved Views", "description": "Create, update, or delete task monitor saved views.", "super_admin_only": False},
    {"code": "tasks.monitor.manage_alert_rule", "module": "tasks", "label": "Manage Task Monitor Alert Rules", "description": "Create, update, or delete task monitor alert rules.", "super_admin_only": False},
    {"code": "tasks.monitor.execute_action", "module": "tasks", "label": "Execute Task Monitor Actions", "description": "Acknowledge or resolve task monitor alerts.", "super_admin_only": False},
    {"code": "tasks.sensitive_metrics.view", "module": "tasks", "label": "View Sensitive Task Metrics", "description": "View sensitive financial metrics in task monitoring.", "super_admin_only": False},
    ...
    {"code": "whatsapp_phone_pool.view", "module": "whatsapp_phone_pool", "label": "查看号码池", "description": "查看站点 WhatsApp 服务号码池。", "super_admin_only": False},
    {"code": "whatsapp_phone_pool.manage", "module": "whatsapp_phone_pool", "label": "管理号码池", "description": "新增、调整、停用站点号码池配置。", "super_admin_only": False},
    {"code": "whatsapp_auth.view", "module": "whatsapp_auth", "label": "查看 WhatsApp 认证", "description": "查看登录、绑定、自动绑定会话与记录。", "super_admin_only": False},
    {"code": "whatsapp_auth.manage", "module": "whatsapp_auth", "label": "管理 WhatsApp 认证", "description": "处理登录、绑定、自动绑定异常与干预操作。", "super_admin_only": False},
    {"code": "teams.view", "module": "teams", "label": "查看团队归属", "description": "查看团队、主管、成员归属关系。", "super_admin_only": False},
    {"code": "teams.manage", "module": "teams", "label": "管理团队归属", "description": "创建团队、调整主管和成员归属。", "super_admin_only": False},
    {"code": "data_scope.view", "module": "data_scope", "label": "查看数据范围", "description": "查看数据范围授权和生效情况。", "super_admin_only": False},
    {"code": "data_scope.manage", "module": "data_scope", "label": "管理数据范围", "description": "授予、撤销和调整数据范围。", "super_admin_only": False},
    {"code": "handover.view", "module": "handover", "label": "查看转接队列", "description": "查看人工转接队列和 AI 转接策略。", "super_admin_only": False},
    {"code": "handover.manage", "module": "handover", "label": "管理转接策略", "description": "管理转接队列、队列策略和 AI 转接策略。", "super_admin_only": False},
    {"code": "h5_gateway.view", "module": "h5_gateway", "label": "查看 H5 网关", "description": "查看 B 服务器网关节点、任务和发布记录。", "super_admin_only": False},
    {"code": "h5_gateway.manage", "module": "h5_gateway", "label": "管理 H5 网关", "description": "管理网关节点、发布、证书、域名封禁与回滚。", "super_admin_only": True},
    {"code": "h5_gateway.secret.view", "module": "h5_gateway", "label": "查看网关密钥摘要", "description": "查看 H5 网关凭据摘要与轮换状态。", "super_admin_only": True},
    {"code": "finance.reconciliation.view", "module": "finance", "label": "查看对账", "description": "查看支付对账任务和差异项。", "super_admin_only": False},
    {"code": "finance.reconciliation.run", "module": "finance", "label": "执行对账", "description": "触发支付对账与差异检测。", "super_admin_only": False},
    {"code": "finance.reconciliation.repair", "module": "finance", "label": "处理对账差异", "description": "基于对账差异创建补单或关闭差异。", "super_admin_only": False},
]
